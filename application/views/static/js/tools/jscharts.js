...
function mx() {
	...
	this.bd = 'JSChart_';
	this.be = false;
	this.bf = ['#ed1c24', '#fff200', '#00a651', '#005e20', '#2e3192', '#ec008c', '#898989', '#f26522', '#00aeef', '#959595', '#662d91', '#8c6239', '#197b30', '#8dc63f', '#a186be', '#736357', '#9e0b0f', '#959595', '#4390d3', '#5f5ab5', '#f06eaa', '#998675', '#790000', '#0054a6', '#003663', '#363636', '#32004b', '#7b0046', '#b1e467', '#aa83d5'];
	this.bg = {};
	this.bh = false;
	this.bi = [];
	this.bj = [];
	...
	this.eA = true;
	this.eB = '';
	this.eC = function(err) {
		if (this.dn) {
			alert(this.eD[err])
		}
	};
	this.eE = function(eF, eG, eH) {
		if (eF.attachEvent) {
			eF.attachEvent('on' + eG, eH);
			return true
		} else if (eF.addEventListener) {
			eF.addEventListener(eG, eH, false);
			return true
		}
		return false
	};
	this.eI = function() {
		this.ew += '';
		this.eJ += '35b69785d29';
		this.ey += '9211e58871';
		this.eB += '5c5ed511a75e';
		try {
			this.ba.getContext('2d')
		} catch(err) {
			return false
		}
		return true
	};
	this.eK = function(eL, eM, coords) {
		if (typeof coords === 'undefined') {
			coords = false
		}
		if ((eL < this.bu || eL > this.bu + this.dq || eM < this.bv || eM > this.bv + this.dr) && coords === true) {
			return false
		}
		if ((eL < this.df || eL > this.db || eM < this.dg || eM > this.dc) && coords === false) {
			return false
		}
		return true
	};
	this.eN = function(name) {
	...
	this.eO = function(type) {
		var eP = this.mA.length;
	...
	this.eR = function(eP, eS) {
		...
		var fc = 0;
		var fd = this.dq / eP;
		var fe = this.ff((eT - eU) / eP, eV);
		var fg = eU;
		var fh = this.bu;
		var fi;
		while (fh < this.dq + 20) {
			fi = String(this.ff(fg, this.eV));
			if (typeof eW === 'string') {
				fi = eW + fi
			}
			if (typeof eX === 'string') {
			...
			var fj = this.fk(fi, eZ, null, null, fb);
			if (fg === eU) {
				fj = fj / 2
			}
			fg += fe;
		...
		fc += this.fk(fi, eZ, null, null, fb) / 2;
		if (this.dq - fc - eP * fa > 0) {
			return true
		}
		return false
	};
	this.fl = function(eP, fm) {
		var fc = 0;
		var fd = this.dr / eP;
		var fe = (this.dc - this.dg) / eP;
		var fg = this.dg;
		var fn = this.bv + this.dr;
		while (fn > this.bv) {
		...
		if (typeof fm === 'undefined') {
			...
			if (fm && fq > this.fp(this.N) * (eP - 1) * 2) {
				return false
			}
			return true
		}
	...
	this.fr = function(fs) {
		var ft = (fs instanceof Array) ? [] : {};
		for (var eQ in fs) {
			if (fs[eQ] && typeof fs[eQ] === "object") {
				ft[eQ] = this.fr(fs[eQ])
			} else {
				ft[eQ] = fs[eQ]
			}
	...
	this.fu = function() {
		this.ew += '';
		this.eJ += 'd3d3d20727';
		this.ey += 'aaa15dd435b';
		this.eB += 'ec0f900b57';
		if (this.fv()) {
		...
		canvas.setAttribute('id', this.bd + this.di);
		canvas.setAttribute('width', this.ds);
		canvas.setAttribute('height', this.dt);
		canvas.style.width = this.ds + 'px';
		canvas.style.height = this.dt + 'px';
		canvas.style.position = 'relative';
		canvas.style.backgroundColor = this.bb;
		this.bg.appendChild(canvas);
		this.ba = canvas;
		this.bc = this.bd + this.di;
		this.fw()
	};
	this.fw = function() {
		if (this.eA == false) {
		...
		var err;
		try {
			fx = 'body #' + this.di + ', body #' + this.di + ' * {' + 'background:none fixed transparent left top no-repeat;' + 'border:none;' + 'bottom:auto;' + 'clear:none;' + 'cursor:auto;' + 'direction:ltr;' + 'display:block;' + 'float:none;' + 'font-family:"Lucida Grande","Lucida Sans Unicode","Lucida Sans",' + 'Verdana,Arial,Helvetica,sans-serif;' + 'font-size:10px;' + 'font-size-adjust:none;' + 'font-stretch:normal;' + 'font-style:normal;' + 'font-variant:normal;' + 'font-weight:normal;' + 'layout-flow:horizontal;' + 'layout-grid:none;' + 'left:0px;' + 'letter-spacing:normal;' + 'line-break:normal;' + 'line-height:normal;' + 'list-style:disc outside none;' + 'margin:0px 0px 0px 0px;' + 'max-height:none;' + 'max-width:none;' + 'min-height:0px;' + 'min-width:0px;' + 'outline-color:invert;' + 'outline-style:none;' + 'outline-width:medium;' + 'overflow:visible;' + 'padding:0px;' + 'position:static;' + 'right:auto;' + 'text-align:left;' + 'text-decoration:none;' + 'text-indent:0px;' + 'text-shadow:none;' + 'text-transform:none;' + 'top:0px;' + 'vertical-align:baseline;' + 'visibility:visible;' + 'width:auto;' + 'word-spacing:normal;' + 'z-index:1;' + 'zoom:1;' + 'opacity:1;' + '-webkit-animation: none;' + '-moz-animation: none;' + '-o-animation: none;' + '-moz-box-shadow: none;' + '-webkit-box-shadow: none;' + 'box-shadow: none;' + '-webkit-border-radius: 0px;' + '-moz-border-radius: 0px;' + 'border-radius: 0px;' + '}';
			var fy = document.getElementsByTagName('head')[0],
			style = document.createElement('style'),
			rules = document.createTextNode(fx);
			style.type = 'text/css';
			if (style.styleSheet) style.styleSheet.cssText = rules.nodeValue;
			else style.appendChild(rules);
			fy.appendChild(style)
		} catch(err) {}
	};
	this.fz = function() {
		var map = document.createElement('MAP');
		map.setAttribute('name', 'map_' + this.bc);
		map.setAttribute('id', 'map_' + this.bc);
		this.bg.appendChild(map);
		return map
	};
	this.fA = function(map, coords) {
		var fB = document.createElement('AREA');
		fB.setAttribute('shape', 'poly');
		fB.setAttribute('coords', coords);
		map.appendChild(fB);
		return fB
	};
	this.fC = function(map) {
		var fD = '<img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" ' + 'width="' + this.ds + '" ' + 'height="' + this.dt + '" ' + 'usemap="#map_' + this.bc + '" ' + 'style="border:0;position:absolute;left:' + this.ba.offsetLeft + 'px;top:' + this.ba.offsetTop + 'px;' + 'clip:\'rect(0, ' + this.ds + 'px, ' + this.dt + 'px, 0)\';' + 'filter:alpha(opacity=0);' + 'z-index:' + (this.ba.style.zIndex + 10) + ';">';
		map.innerHTML += fD;
		return fD
	};
	this.fE = function(eL, eM, fF, fG, fH) {
		var fI = document.createElement('DIV');
		fI.style.position = 'absolute';
		fI.style.left = (this.ba.offsetLeft + fF) + 'px';
		fI.style.top = (this.ba.offsetTop + fG) + 'px';
		fI.style.border = this.dP;
		fI.style.borderRadius = '6px';
		fI.style.padding = this.dW;
		fI.style.backgroundColor = this.dO;
		//fI.style.background = 'image/special_tip.png';
		fI.style.fontSize = this.dT + 'px';
		fI.style.fontFamily = this.dS;
		fI.style.color = this.dR;
		fI.style.fJ = this.dV;
		fI.style.filter = 'alpha(opacity=' + (this.dV * 100) + ')';
		fI.style.display = 'none';
		fI.style.zIndex = Number(this.ba.style.zIndex) + 100;
		fI.setAttribute('id', 'tooltip_' + this.bc + '_' + eL + '_' + eM);
		if (fH === null || fH === '' || fH === ' ') {
			fI.innerHTML = this.m + ': ' + eL + '<br>' + this.mH + ': ' + eM
		} else {
			fI.innerHTML = fH
		}
		fI.position = this.dX;
		fI.fK = this.dU;
		fI.fF = this.ba.offsetLeft + fF;
		fI.fG = this.ba.offsetTop + fG;
		return fI
	};
	this.fL = function(eL, eM, fF, fG, fH, fM) {
		if (this.ba.style.zIndex === '') {
			this.ba.style.zIndex = 1
		}
		if (true) {
			var fI = this.fE(eL, eM, fF, fG, fH);
			var expand = 5;
			var width = this.br * 2 + this.bt * 2 + expand * 2 + 5;
			var height = this.br * 2 + this.bt * 2 + expand * 2 + 5;
			var fN = false;
			var canvas = document.createElement('CANVAS');
			canvas.setAttribute('id', fI.getAttribute('id') + '_over');
			canvas.style.position = 'absolute';
			canvas.style.display = 'none';
			canvas.style.left = (this.ba.offsetLeft + fF - width / 2) + 'px';
			canvas.style.top = (this.ba.offsetTop + fG - height / 2) + 'px';
			canvas.style.width = width + 'px';
			canvas.width = width;
			canvas.style.height = height + 'px';
			canvas.height = height;
			canvas.style.zIndex = Number(this.ba.style.zIndex) + 90;
			this.bg.appendChild(canvas);
			if (!this.fO(canvas) && this.fP()) {
				canvas = G_vmlCanvasManager.initElement(canvas);
				fN = true
			}
			var fQ = canvas.getContext('2d');
			fQ.beginPath();
			fQ.lineWidth = this.bt;
			fQ.strokeStyle = this.fR(this.bn, (this.bt === 0) ? 0 : this.bq);
			switch (this.bs) {
			case 'square':
				fQ.moveTo(canvas.width / 2 - this.br - expand, canvas.height / 2 + this.br + expand);
				fQ.lineTo(canvas.width / 2 - this.br - expand, canvas.height / 2 - this.br - expand);
				fQ.lineTo(canvas.width / 2 + this.br + expand, canvas.height / 2 - this.br - expand);
				fQ.lineTo(canvas.width / 2 + this.br + expand, canvas.height / 2 + this.br + expand);
				fQ.closePath();
				break;
			case 'triangle':
				fQ.moveTo(width / 2 - (this.br + expand) * Math.cos(Math.PI / 6), height / 2 + (this.br + expand) * Math.cos(Math.PI / 3));
				fQ.lineTo(width / 2, height / 2 - this.br - expand);
				fQ.lineTo(width / 2 + (this.br + expand) * Math.cos(Math.PI / 6), height / 2 + (this.br + expand) * Math.cos(Math.PI / 3));
				fQ.closePath();
				break;
			case 'diamond':
				fQ.moveTo(canvas.width / 2 - this.br - expand, canvas.height / 2);
				fQ.lineTo(canvas.width / 2, canvas.height / 2 - this.br - expand);
				fQ.lineTo(canvas.width / 2 + this.br + expand, canvas.height / 2);
				fQ.lineTo(canvas.width / 2, canvas.height / 2 + this.br + expand);
				fQ.closePath();
				break;
			case 'circle':
			default:
				fQ.arc(width / 2, height / 2, this.br + expand, 0, Math.PI * 2, false)
			}
			if (this.bo !== false) {
				fQ.fillStyle = this.fR(this.bo, this.bq);
				fQ.fill()
			}
			fQ.stroke();
			if (fN) {
			...
			var fT = function() {
				var eF = document.getElementById(fI.getAttribute('id') + '_over');
				eF.style.display = 'block';
				var eF = document.getElementById(fI.getAttribute('id') + '_flag');
				eF.style.display = 'none';
				if (fH !== false && fH !== 'false') {
					eF = document.getElementById(fI.getAttribute('id'));
					eF.style.display = '';
					switch (eF.position) {
					case 'nw':
						eF.style.left = (parseInt(eF.fF, 10) - eF.fK - eF.scrollWidth) + 'px';
						eF.style.top = (parseInt(eF.fG, 10) - eF.fK - eF.scrollHeight) + 'px';
						break;
					case 'ne':
						eF.style.left = (parseInt(eF.fF, 10) + eF.fK) + 'px';
						eF.style.top = (parseInt(eF.fG, 10) - eF.fK - eF.scrollHeight) + 'px';
						break;
					case 'sw':
						eF.style.left = (parseInt(eF.fF, 10) - eF.fK - eF.scrollWidth) + 'px';
						eF.style.top = (parseInt(eF.fG, 10) + eF.fK) + 'px';
						break;
					default:
						eF.style.left = (parseInt(eF.fF, 10) + eF.fK) + 'px';
						eF.style.top = (parseInt(eF.fG, 10) + eF.fK) + 'px'
			...
			var fU = function() {
				document.getElementById(fI.getAttribute('id')).style.display = 'none';
				document.getElementById(fI.getAttribute('id') + '_over').style.display = 'none';
				document.getElementById(fI.getAttribute('id') + '_flag').style.display = ''
			};
			this.bg.appendChild(fI);
			var fV = this.fW(eL, eM, fF, fG, fM);
			this.eE(fV, 'mouseover', fT);
			this.eE(fV, 'mouseout', fU);
			this.bg.appendChild(fV)
		}
	};
	this.fW = function(eL, eM, fF, fG, fM) {
		var fV = '<div ' + 'style="position:absolute;' + 'left:' + (this.ba.offsetLeft + fF - this.br) + 'px;' + 'top:' + (this.ba.offsetTop + fG - this.br) + 'px;' + 'width:' + (this.br * 2) + 'px;' + 'height:' + (this.br * 2) + 'px;' + 'font-size: 1px;' + 'z-index: ' + (Number(this.ba.style.zIndex) + 200) + ';' + '" id="trigger_' + eL + '_' + eM + '">' + '<img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" ' + 'width="' + (this.br * 2) + '" ' + 'height="' + (this.br * 2) + '" ' + "><\/div>";
	...
	this.gd = function() {
		var fN = false;
		this.ew = '';
		this.eJ = '28634848203';
		this.ey = '087dfb218f6';
		this.eB = '1f0959efb1';
		if (this.fv()) {
		...
		if (this.uC === '') {
			...
			setTimeout((function(fs) {
				return function() {
					var fX = document.createElement('div');
					var fD = gC + 'style="border:0; height: auto;"/>';
					fX.innerHTML = fD;
			...
			if (String(jK.tagName).toLowerCase() === 'dataset') {
				...
				if (typeof jG[0][0] === 'string' && this.ec === 'line') {
					if (this.bi.length === 0) {
						...
						for (var jS = 0,
						ha = min; ha < max, jS < jG.length; ha += fd, jS++) {
	...
	this.gg = function() {
		...
		for (var iU = 0; iU < kj; iU++) {
			...
			for (eQ = 0; eQ < eP; eQ++) {
				...
				fV = '<div ' + 'style="position:absolute;' + 'left:' + (this.ba.offsetLeft + fh) + 'px;' + 'top:' + (this.ba.offsetTop + fn) + 'px;' + 'width: 10px;' + 'height: 10px;' + 'font-size: 1px;' + 'z-index: ' + (Number(this.ba.style.zIndex) + 200) + ';' + '" id="trigger_legend_' + parseInt(fh, 10) + '_' + parseInt(fn, 10) + '">' + '<img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" ' + 'width="' + (this.br * 2) + '" ' + 'height="' + (this.br * 2) + '" ' + "><\/div>";
	...
	this.setDataArray = function(data, id, usestring) {
		...
		if ((typeof data[0][0] === 'string' || usestring === true) && ml.ec === 'line') {
			if (ml.bi.length === 0) {
				...
				for (var jS = 0,
				eQ = min,
				eP = data.length; eQ < max, jS < eP; eQ += fd, jS++) {
